...
export default function IssueCertificatePage() {
  ...
  const [issuanceResults, setIssuanceResults] = useState(null);
      ...
      render: (certificate) => (
        <div className="flex gap-1">
          {certificate.badgeTitles.length > 0 ? (
            certificate.badgeTitles.map((badge, index) => (
        ...
        return (
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              {currentReviewCertificates.map((certificate) => (
              ...
              <div className="space-y-4">
                ...
                {issuanceResults.success.length > 0 && (
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-2">
                        {issuanceResults.success.map((result, index) => (
                ...
                {issuanceResults.errors.length > 0 && (
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-2">
                        {issuanceResults.errors.map((error, index) => (
