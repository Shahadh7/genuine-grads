...
export default function VerificationLogPage(): React.JSX.Element {
  const [session, setSession] = useState<any>(null);
  const [logs, setLogs] = useState<any>(mockVerificationLogs);
  const [filteredLogs, setFilteredLogs] = useState<any>(mockVerificationLogs);
