...
export default function CertificatesPage(): React.JSX.Element {
  ...
  const [certificates, setCertificates] = useState<any>(mockCertificates);
  const [filteredCertificates, setFilteredCertificates] = useState<any>(mockCertificates);
  const [searchTerm, setSearchTerm] = useState<any>('');
  const [statusFilter, setStatusFilter] = useState<any>('all');
  const [universityFilter, setUniversityFilter] = useState<any>('all');
